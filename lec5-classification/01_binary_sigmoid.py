...
def demonstrate_sigmoid_curve():
    ...
    plt.axhline(
        y=0.5, color="r", linestyle="--", alpha=0.5, label="Decision threshold (0.5)"
    )
...
if __name__ == "__main__":
    ...
    print(
        "  2. For binary classification, sigmoid converts linear output to probability"
    )
    print("  3. Probability > 0.5 typically means class 1, < 0.5 means class 0")
    print(
        "  4. Sigmoid is smooth and differentiable, making it good for gradient-based learning"
    )
